...
export class CreateTaskEntitie1690222651485 implements MigrationInterface {
    name = 'CreateTaskEntitie1690222651485'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "valor" integer NOT NULL, "custo" integer NOT NULL, "estoque" integer NOT NULL, CONSTRAINT "PK_36a07cc432789830e7fb7b58a83" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "Sales" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "valor" integer NOT NULL, "produto" character varying NOT NULL, "status" character varying(10) NOT NULL, "quantidade" integer NOT NULL, CONSTRAINT "PK_42b06288cc6e50ea7f5bca1e212" PRIMARY KEY ("id"))`);
